    ...
    public class DrawImage
    {
        ...
        */
        ...
        public static void DrawVisual(List<List<List<int>>> Blocks,Color top, Color left, Color right)
        {
            ...
            /*я короч заебался, напишу утречком, а пока план работ
             * надо сделать цикл, где построчно (по зетам) рисуются кубики
             * в начале рисуются левые и правые грани
             * потом верхние
             * после этого переходим на один слой вверх и по-новой
             * 
             * снизу (под этой функцией) есть функция преобразования координат
             *           ||
             *           \/
            */
        }
